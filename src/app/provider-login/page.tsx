    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-4 md:p-8 bg-black text-white">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight">KAWAI Provider</h1>
          ...
          <div className="flex-1">
            <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700 h-full">
              <CardContent className="p-6 flex flex-col items-center">
                ...
                <h2 className="text-xl font-bold mb-4">Become a KAWAI Provider</h2>
                <p className="text-gray-400 mb-6 text-center">
                  Earn KAWAI tokens by providing computational resources to the decentralized AI network.
                </p>
                <div className="bg-gray-800 p-4 rounded-lg w-full">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center">
                      ...
                      <span>Compatible hardware for computation</span>
                    </li>
                  </ul>
                </div>
              </CardContent>
            ...
            <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700">
                ...
                {connected && publicKey && (
                  <div className="w-full text-center space-y-4">
                    ...
                    {!isLoading && !error && kawaiBalance !== null && (
                      <>
                        {hasSufficientKawai ? (
                          <Alert className="bg-orange-900/30 border-orange-500 text-white">
                              ...
                              <div className="mt-4">
                                <Button className="w-full bg-orange-600 hover:bg-orange-700" asChild>
                                  <Link href="/provider-dashboard">
                                    Enter KAWAI Provider Dashboard
                                  </Link>
                                </Button>
                              </div>
                            </AlertDescription>
              ...
              <CardFooter className="flex justify-center pt-0">
                <p className="text-xs text-gray-500">
                  Earn by contributing to the KAWAI decentralized AI computation network
                </p>
              </CardFooter>
            </Card>
          </div>
