      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-4 md:p-8 bg-black text-white">
        <div className="w-full max-w-md mx-auto text-center">
          <Alert variant="destructive" className="mb-6">
            ...
            <AlertDescription>
              You need to authenticate with your wallet to access the Agent Dashboard.
            </AlertDescription>
          </Alert>
    ...
    <main className="flex min-h-screen flex-col items-center p-4 md:p-8 bg-black text-white">
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <Alert variant="default" className="bg-green-100 dark:bg-green-900/30 border-green-300 dark:border-green-700 max-w-2xl mx-auto">
            <Shield className="h-4 w-4 text-green-600 dark:text-green-400" />
            <AlertTitle className="text-green-800 dark:text-green-300">🎉 Successfully Authenticated!</AlertTitle>
            <AlertDescription className="text-green-700 dark:text-green-400">
              Welcome to your KAWAI Agent Dashboard. Your wallet authentication has been verified.
            </AlertDescription>
          </Alert>
        </div>
        ...
        <div className="mt-8 bg-[#1a1f2e] border border-[#2a3042] rounded-lg p-8">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="text-center text-gray-400 space-y-2">
              ...
              <p>🤖 AI agents will be accessible through this interface.</p>
            </div>
          </div>
        </div>
      </div>
